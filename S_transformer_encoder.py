...
class TransformerEncoderLayer(nn.Module):
    def __init__(
        self, d_model, heads, d_ff, dropout, att_drop=0.1, use_structure=True, alpha=1.0, beta=1.0
    ):
        super(TransformerEncoderLayer, self).__init__()

        self.self_attn = MultiHeadedAttention(
            heads, d_model, dropout=att_drop, use_structure=True, alpha=alpha, beta=beta
        )
